...
import { WeekDay, CalendarEvent, CalendarResource, WeekViewAllDayEvent, WeekViewHourColumn, WeekViewTimeEvent, WeekViewHourSegment, WeekViewHour, WeekViewAllDayEventRow, ResourceWeekView, ResourcesMaxRowNumber, ResourcesMaxRowsNumber } from 'calendar-utils';
...
export interface ResourceWeekViewAllDayEventResize {
    originalOffset: number;
    originalSpan: number;
    edge: string;
}
export interface CalendarResourceWeekViewBeforeRenderEvent extends ResourceWeekView {
    header: WeekDay[];
}
/**
 ...
 * ```
 */
export declare class CalendarResourceWeekViewComponent implements OnChanges, OnInit, OnDestroy, AfterViewInit {
     ...
     * @hidden
     */
    allDayEventResizes: Map<WeekViewAllDayEvent, ResourceWeekViewAllDayEventResize>;
    /**
     * @hidden
     */
     ...
     * @hidden
     */
    trackByRowColumn: (index: number, column: import("calendar-utils").ResourceWeekViewRowColumn<any, any>) => string | number;
    /**
     * @hidden
     */
